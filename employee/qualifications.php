...
<head>
	...
	<title>Employee Details - Professional Qualifications</title>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Employee Details</h5>
											<p>Employee Details is a job portal, online job management system developed by Bwire C Mashauri in November 2023.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Employee Details Contact</h5>
								
								<p>Address : Dar es salaam, Tanzania PO.BOX 14859</p>
								<p>Email : <a href="mailto:diamondcore@gmail.com">diamondcore@gmail.com</a></p>
								<p>Phone : <a href="tel:+255689938643">+84 349 402 518</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> DiamondCore</p>
