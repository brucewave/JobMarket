		...
		<div class="main-wrapper">
			<div class="hero" style="background-image:url('images/hero-header/01.jpg');">
				<div class="container">
					...
					<p>Finding your next job or career on Job Market</p>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>Job Market is a job portal, online job management system developed by
												Diamond Core for his project in November 2023.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address : Trung Nu Vuong, Hai Chau, Da Nang</p>
								<p>Email : <a href="mailto:diamondcore@gmail.com">diamondcore@gmail.com</a>
								</p>
								<p>Phone : <a href="tel:+84349402518">0349402518</a></p>
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright
									<?php echo date('Y'); ?> Diamond Core Software
								</p>
