...
<head>
	...
	<title>Job Market - <?php echo "$myfname"; ?> <?php echo "$mylname"; ?></title>
    ...
    <meta property="og:image:alt" content="Employee Details" />
								...
								<div class="employee-detail-wrapper">
									...
									<div class="employee-detail-header text-center">
										...
										<ul class="meta-list clearfix">
											...
											<li>
												<?php
													if (isset($byear) && is_numeric($byear)) {
														$myage = date("Y") - $byear;
														echo '<h4 class="heading">Age:</h4>' . $myage . ' Years Old';
													} else {
														echo '<h4 class="heading">Age:</h4>Date of birth has not been entered';
													}
												?>
